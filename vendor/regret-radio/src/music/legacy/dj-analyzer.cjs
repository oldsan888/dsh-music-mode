...
module.exports = {
  ...
  // D1-D5 迁移期临时导出（供 TS 侧逐字对拍 CJS vs TS 全等）；DSP 全迁完（D8 删/退役 CJS）时一并移除。
  __dsp: { clamp01, clampRange, percentile, median, makeBiquad, runBiquad },
  __decodeRange: decodePodcastDjEnergyRange,
};
